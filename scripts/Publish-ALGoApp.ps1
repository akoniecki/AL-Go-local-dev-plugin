param(
    ...
    [switch] $IncludeAssociatedTestApp,
...
if ($IncludeAssociatedTestApp -and $null -ne $context.AssociatedTestApp -and ($targetApps.Id -notcontains $context.AssociatedTestApp.Id)) {
...
if ($IncludeAssociatedTestApp -and $null -ne $context.AssociatedTestApp) {
